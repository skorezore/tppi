...
public:
    ...
    const vec3& coordinates() const noexcept { return coordinates_; }
    void coordinates(const vec3& new_coordinates) noexcept { coordinates_ = new_coordinates; }
...
const vec3& renderable::coordinates() const noexcept { return renderable_implementation_->coordinates(); }
void renderable::coordinates(const vec3& new_coordinates) noexcept { renderable_implementation_->coordinates(new_coordinates); }
